...
const NavBar = (props) => {
  ...
  // clickedSubIcons //
  //-----------------//
  const [clickedSubIcons, setClickedSubIcons] = useState({
    ...Object.keys(navBarIcons).reduce((accumulator, iconName) => {
      accumulator[iconName] = false;
      return accumulator;
    }, {}),
  });
        ...
        return (
          <div
            ...
            onClick={() => {
              handleOnClick();
              setClickedSubIcons({
                ...Object.assign(clickedSubIcons, {
                  [subIconName]: !clickedSubIcons[subIconName],
                }),
              });
            }}
          >
            {clickedSubIcons[subIconName]
              ? clickedNavBarIcons[subIconName]
